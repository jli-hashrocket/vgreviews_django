...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'reviews_console', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'reviews', ['Console'])

        # Adding M2M table for field consoles on 'Review'
        m2m_table_name = db.shorten_name(u'reviews_review_consoles')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('review', models.ForeignKey(orm[u'reviews.review'], null=False)),
            ('console', models.ForeignKey(orm[u'reviews.console'], null=False))
        ))
        db.create_unique(m2m_table_name, ['review_id', 'console_id'])


    def backwards(self, orm):
        # Deleting model 'Console'
        db.delete_table(u'reviews_console')

        # Removing M2M table for field consoles on 'Review'
        db.delete_table(db.shorten_name(u'reviews_review_consoles'))
    ...
    models = {
        ...
        u'reviews.review': {
            ...
            'consoles': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'reviews'", 'symmetrical': 'False', 'to': u"orm['reviews.Console']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
